...
import (
	...
	mocksvc "github.com/yohnnn/public-survey-platform/back/services/user-service/internal/service/mock"
...
func newUserServiceForTest(
	...
	return NewUserService(users, sessions, txMgr, hasher, tokens, clock, ids)
}
...
func TestLoginSuccessIssuesTokensAndCreatesSession(t *testing.T) {
	...
	svc := newUserServiceForTest(users, sessions, hasher, tokens, clock, ids)
